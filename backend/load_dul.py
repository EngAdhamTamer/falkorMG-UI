...
def main():
    print("Parsing DUL (DOLCE+DnS Ultralite)...")
    g = Graph()
    ...
    print(f"Loaded {count} subClassOf edges")
    ...
    print(f"Loaded {prop_count} subPropertyOf edges")
    print(f"Total edges: {count + prop_count}")
